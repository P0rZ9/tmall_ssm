                ...
                <div>
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle" action="admin_product_image_add" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${p_image_single}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                ...
                                <td><a deleteLink="true"
                                       href="/admin_product_image_delete?id=${pi.id}"><span
            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormDetail" action="admin_product_image_add" enctype="multipart/form-data">
                                <table class="addTable">
                                    <tr>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${p_image_detail}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
