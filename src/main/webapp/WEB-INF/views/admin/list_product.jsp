        ...
        <table
            ...
            <c:forEach items="${products}" var="p">
                <tr>
                    ...
                    <td>${p.stock}</td>
                    <td><a href="admin_product_image_list?pid=${p.id}"><span
                            class="glyphicon glyphicon-picture"></span></a></td>
                    <td><a href="admin_property_value_edit?pid=${p.id}"><span
        ...
        <div class="panel-body">
            <form method="post" id="addForm" action="admin_product_add">
                <table class="addTable">
                    ...
                    <tr>
                        <td>原价格</td>
                        <td><input id="originalPrice" value="" name="originalPrice" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr>
                        <td>优惠价格</td>
                        <td><input id="promotePrice"  value="" name="promotePrice" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr>
                        <td>库存</td>
