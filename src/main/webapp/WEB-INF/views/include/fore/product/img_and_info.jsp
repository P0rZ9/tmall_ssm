...
<div class="imgAndInfo">
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="productSaleAndReviewNumber">
            <div>销量 <span class="redColor boldWord"> ${p.sale_count}</span></div>
            <div>累计评价 <span class="redColor boldWord"> ${p.review_count}</span></div>
        </div>
        ...
        <div class="buyDiv">
            <a class="buyLink" href="fore_buy_one?pid=${p.id}"><button class="buyButton">立即购买</button></a>
            <a class="addCartLink" href="fore_add_cart"><button class="addCartButton"><span class="glyphicon glyphicon-shopping-cart"></span>加入购物车</button></a>
        </div>
    </div>
