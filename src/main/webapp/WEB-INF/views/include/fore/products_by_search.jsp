...
<div class="searchProducts">
    ...
    <div class="productUnit" price="${p.promotePrice}">
        ...
        <div class="productInfo">
            <span class="monthDeal ">月成交 <span class="productDealNumber">${p.sale_count}笔</span></span>
            <span class="productReview">评价<span class="productReviewNumber">${p.review_count}</span></span>
