                    ...
                    <tr class="orderItemProductInfoPartTR" >
                        ...
                        <td class="orderItemProductInfoPartTD">
                            <div class="orderListItemProductLinkOutDiv">
                                <a href="fore_product?pid=${oi.product.id}">${oi.product.name}</a>
                        ...
                        <c:if test="${st.count==1}">
                            ...
                            <td valign="top" rowspan="${fn:length(o.orderItemList)}" class="orderListItemButtonTD orderItemOrderInfoPartTD" width="100px">
                                <c:if test="${o.status=='waitConfirm' }">
                                    <a href="/fore_confirm_pay?oid=${o.id}">
                                        <button class="orderListItemConfirm">确认收货</button>
                                    </a>
                                </c:if>
                                <c:if test="${o.status=='waitPay' }">
                                    <a href="fore_alipay?oid=${o.id}&total=${o.total}">
