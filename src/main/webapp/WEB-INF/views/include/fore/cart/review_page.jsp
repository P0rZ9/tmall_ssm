    ...
    <div class="reviewProductInfoDiv">
        ...
        <div class="reviewProductInfoRightDiv">
            ...
            <table class="reviewProductInfoTable">
                ...
                <tr>
                    <td>月销量:</td>
                    <td><span class="reviewProductInfoTableSellNumber">${p.sale_count}</span> 件</td>
                </tr>
            </table>
...
于<fmt:formatDate value="${o.createDate}" pattern="yyyy年MM月dd"/>下单购买了此商品 </span>
    ...
    <div class="reviewStasticsDiv">
        <div class="reviewStasticsLeft">
            ...
            <div class="reviewStasticsLeftContent">累计评价 <span class="reviewStasticsNumber"> ${p.review_count}</span></div>
    ...
    <c:if test="${param.showonly!=true}">
        <div class="makeReviewDiv">
            <form method="post" action="fore_do_review">
